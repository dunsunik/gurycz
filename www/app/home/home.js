 ...
 */
.controller( 'HomeCtrl', [ '$scope', '$rootScope', 'titleService', 'picasaService', 'cache', function HomeController( $scope, $rootScope, titleService, picasaService, cache ) {
